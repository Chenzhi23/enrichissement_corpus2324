...
class Simple(models.Model):
    ...
    nom_fichier = models.CharField(max_length=32, verbose_name='nom_fichier')
...
class EnrichiDynamique(models.Model):
    '''<dyn></dyn>'''
    id = models.AutoField(primary_key=True)
    nom_fichier = models.CharField(max_length=32, verbose_name='nom du fichier')
...
class EnrichiNouvelle(models.Model):
    ...
    num_phrase = models.BigIntegerField(verbose_name='numéro de la phrase')
    dynamique = models.TextField(verbose_name='dynamique')
    segment_annote = models.TextField(verbose_name='segment annoté de la nouvelle')
    ...
    type_nouvelle = models.CharField(max_length=16, verbose_name='attribut', choices=choices_type)
